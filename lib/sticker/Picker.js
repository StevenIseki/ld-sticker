...
var _default = function (_Component) {
  ...
  function _default(props) {
    ...
    _this.loadTrendingStickers();
    return _this;
  }

  _createClass(_default, [{
    key: 'loadTrendingStickers',
    value: function loadTrendingStickers() {
      var _this2 = this;
      ...
      fetch(giphyTrendingUrl, {
        ...
        var stickers = response.data.map(function (g, i) {
          return g.images;
        });
        _this2.setState({ stickers: stickers });
      });
    }
  }, {
    key: 'searchStickers',
    value: function searchStickers() {
      var _this3 = this;
      ...
      fetch(url, {
        ...
        _this3.setState({ stickers: stickers });
      });
    }
  }, {
    key: 'onGiphySelect',
    value: function onGiphySelect(sticker) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        GiphyPickerWrapper,
        { className: 'ld-sticker-picker-wrapper-outer', visible: visible },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            Close,
            { width: '24', height: '24', viewBox: '0 0 24 24', className: 'ld-button-sticker-picker-close' },
            _react2.default.createElement(
              'g',
        ...
        _react2.default.createElement(
          GiphyWrapper,
          { className: 'ld-sticker-picker-wrapper' },
          stickers.map(function (g, i) {
            var stickerUrl = g.fixed_width.url;
